...
type OriginButtonProps = Omit<ButtonHTMLAttributesForMotion, "onClick" | "onBlur" | "onFocus" | "onKeyDown" | "onKeyUp" | "onPointerCancel" | "onPointerDown" | "onPointerEnter" | "onPointerLeave" | "onPointerUp"> & {
...
const OriginButton = React.forwardRef<any, OriginButtonProps>(
  (
    {
      children,
      className,
