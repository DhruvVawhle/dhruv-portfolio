  ...
  return (
    ...
    >
      ...
      <div className="border-t border-border-custom/50 pt-5 mt-1 flex flex-col gap-4">
        ...
        {/* Terminal Tab Header */}
        <div className="flex items-center gap-5 border-b border-border-custom/30 pb-2.5 text-[10px] sm:text-xs font-mono text-neutral-500 dark:text-text-secondary select-none overflow-x-auto scrollbar-thin scrollbar-thumb-neutral-300 dark:scrollbar-thumb-neutral-700 scrollbar-track-transparent pb-3.5 whitespace-nowrap">
          <button
